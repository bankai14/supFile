...
|
*/
$config['rest_enable_logging'] = false; // il était a false au départ
...
|
*/
$config['check_cors'] = true; //il était de base a false
...
|
*/
$config['allow_any_cors_domain'] = true; // il était a false de base
